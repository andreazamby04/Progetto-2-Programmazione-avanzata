...
custom_loss = [0.6176, 0.5008, 0.4381, 0.3940, 0.3593]  
resnet_loss = [0.3015, 0.2343, 0.2233, 0.2191, 0.2178] 


custom_acc = [74.16, 77.72, 79.34, 82.70, 83.82] 
resnet_acc = [91.76, 92.60, 92.64, 92.58, 92.64] 
